// frontend/pages/portfolio.tsx — Single Shared Layout
...
const PortfolioPage: NextPage = () => {
  ...
  const handleCreatePortfolio = async (payload: any) => {
    const p = await createPortfolio(payload);
    if (p) {
  ...
  const handleAddHolding = async (payload: any) => {
    ...
    const p = await addHolding(portfolioId, payload);
    if (p) {
  ...
  return (
    <>
      <Head>
        <title>
          {showNewForm 
            ? "New Portfolio — RiskLens"
            : isLoading 
              ? "Portfolio — RiskLens"
              : !portfolio 
                ? "Not Found — RiskLens"
                : `${safeString(portfolio.name)} — RiskLens`
          }
        </title>
      </Head>
      ...
      <div className="app-shell">
        ...
        <header className="app-header">
          <Link href="/" className="app-header__brand">
            ...
            <span className="app-header__brand-text">RiskLens</span>
          </Link>
          <div className="app-header__center">
            {!showNewForm && !isLoading && portfolio && (
        ...
        <main className="page-content animate-in">
          {showNewForm ? (
            ...
            <div className="new-portfolio-container">
              <div className="page-header page-header--new-portfolio">
                <div>
              ...
              <div className="card card--new-portfolio">
                <CreatePortfolioForm
            ...
            <>
              ...
              <div className="stat-grid">
                <div className="stat-card stat-card--accent">
                  ...
                  <div className="stat-card__value">{fmt(safeNumber(portfolio.totalValue))}</div>
                </div>
                ...
                <div className="stat-card">
                  ...
                  <div className="stat-card__value" style={{ 
                    color: safeNumber(portfolio.totalGainLossPct) >= 0 ? "var(--green-bright)" : "var(--red-bright)" 
                  }}>
                    {safeNumber(portfolio.totalGainLossPct) >= 0 ? "+" : ""}
                ...
                <div className="stat-card">
                  ...
                  <div className="stat-card__value" style={{ 
                    ...
                    {safeNumber(portfolio.totalGainLossPct) >= 0 ? "+" : ""}
                    {safeNumber(portfolio.totalGainLossPct).toFixed(2)}%
                  </div>
                </div>
                <div className="stat-card stat-card--highlight">
                  <div className="stat-card__label">VaR 95% (1d)</div>
                  <div className="stat-card__value" style={{ color: "var(--red-bright)" }}>
                    {metrics?.var && Number.isFinite(metrics.var.varDollar) && metrics.var.varDollar > 0 
                      ? fmt(metrics.var.varDollar) 
                      : "—"}
                  </div>
                  {metrics?.var && metrics.var.varPct != null && Number.isFinite(metrics.var.varPct) && (
                    <div className="stat-card__sub">{(metrics.var.varPct * 100).toFixed(2)}% of NAV</div>
                  )}
                </div>
                <div className="stat-card stat-card--highlight">
                  <div className="stat-card__label">CVaR 95% (1d)</div>
                  <div className="stat-card__value" style={{ color: "var(--red-bright)" }}>
                    {metrics?.cvar && Number.isFinite(metrics.cvar.cvarDollar) && metrics.cvar.cvarDollar > 0
                      ? fmt(metrics.cvar.cvarDollar)
                      : "—"}
                  </div>
                </div>
              </div>
              ...
              <div className="tabs">
                {[
                  ...
                  { key: "risk" as Tab, label: "Risk Analysis" },
                  { key: "allocation" as Tab, label: "Allocation" },
              ...
              {tab === "risk" && (
                <div className="risk-tab">
                  {riskLoading ? (
                    ...
                    <div className="empty-state">
                      <h3>Risk Analysis</h3>
                      <p>Add at least one holding to calculate portfolio risk.</p>
      ...
      <style>{`
        ...
        .page-header--new-portfolio .page-header__title {
          font-size: 1.4rem;
          font-weight: 600;
          font-family: var(--font-display);
          color: var(--text-primary);
        ...
        .page-header--new-portfolio .page-header__sub {
          font-size: 0.85rem;
          color: var(--text-muted);
          margin: 0;
        }
        ...
        @media (max-width: 768px) {
          ...
          /* Create Portfolio mobile adjustments */
          .new-portfolio-container {
            max-width: 100%;
            padding: 0;
          }
